...
- all subsequent line corresponds to one gram and its noisy occurance count. The
  ...
  output file is "<dataset>-noisy-n_max_<n_max>-l_max_<sensitivity>-eps_<budget>.dat"
...
The script first creates the set of all (non-noisy) n-grams up to size n_max by
parsing the dataset, and writes this set to a file a file named
"<dataset>_<n_max>grams.dat".  This file will not be deleted, and is used in
